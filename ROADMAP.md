...
- **A FAIRE A LA MAIN** : réimporter dans RapidAPI `~/Bureau/presend-project/rapidapi-exports/presend-openapi.json` (fiche "Presend API" : nom Spamhaus encore affiché, IPv6, exemple tx-decode) ET `presend-openapi-blockchain.json` (fiche "Blockchain & Crypto Compliance" : exemple tx-decode).
