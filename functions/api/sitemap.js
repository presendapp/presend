export async function onRequestGet() {
  ...
  const urls = [
    ...
    { loc: "https://presend.pages.dev/es/tools/exif-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/de/tools/exif-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/pt/tools/exif-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/ja/tools/exif-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/fr/tools/pdf-metadata-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/es/tools/pdf-metadata-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/de/tools/pdf-metadata-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/pt/tools/pdf-metadata-remover", priority: "0.8", changefreq: "monthly" },
    { loc: "https://presend.pages.dev/ja/tools/pdf-metadata-remover", priority: "0.8", changefreq: "monthly" },
